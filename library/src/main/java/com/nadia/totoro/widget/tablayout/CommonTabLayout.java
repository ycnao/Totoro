package com.nadia.totoro.widget.tablayout;
...
import com.nadia.totoro.widget.tablayout.listener.CustomTabEntity;
import com.nadia.totoro.widget.tablayout.listener.OnTabSelectListener;
import com.nadia.totoro.widget.tablayout.utils.FragmentChangeManager;
import com.nadia.totoro.widget.tablayout.utils.UnreadMsgUtils;
import com.nadia.totoro.widget.tablayout.utils.Utils;
import com.nadia.totoro.widget.tablayout.view.MsgView;

import java.util.ArrayList;

/**
 * 没有继承HorizontalScrollView不能滑动,
 * 对于ViewPager无依赖
 * author: Created by 闹闹 on 2018/10/16
 * version: 1.0.0
 */
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
	...
	protected int sp2px(float sp) {
		return Utils.sp2px(mContext, sp);
	}
}
