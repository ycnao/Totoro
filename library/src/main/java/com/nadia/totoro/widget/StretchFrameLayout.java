...
/**
 * Created by naonao on 2017/3/25.
 */
public class StretchFrameLayout extends FrameLayout implements View.OnTouchListener {
    ...
    public StretchFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        initBounce();
    }

    public StretchFrameLayout(Context context, AttributeSet attrs, int defStyle) {
